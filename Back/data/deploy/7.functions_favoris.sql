...
/* DELETE A FAVORIS */
CREATE FUNCTION web.delete_favoris(favoris_id int) RETURNS web.favoris AS $$ 
DELETE FROM
  web.favoris
WHERE
  web.favoris.id = favoris_id 
...
CREATE FUNCTION web.get_user_favoris(user_id int) RETURNS SETOF web.favoris AS $$
SELECT
  *
FROM
  web.favoris
